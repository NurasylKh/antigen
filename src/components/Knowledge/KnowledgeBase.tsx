...
const KNOWLEDGE_ITEMS: IKnowledgeItems[] = [
	{
		title: 'Что такое медицина?',
		category: 'Основы медицины',
		tags: ['введение', 'теория'],
		description: 'Простое объяснение основ медицины для новичков.',
		type: 'article',
		link: '#',
	},
	{
		...
		description: 'Реальный пример применения методик медицины.',
		type: 'article',
		link: '#',
	},
	{
	...
	},
	{
		...
		description: 'Подробный разбор ключевой техники медицины.',
		type: 'article',
		link: '#',
	},
]
