			...
			<div className='container mx-auto px-6 lg:px-20'>
				...
				<div className='flex flex-col lg:flex-row lg:justify-between gap-10 lg:gap-6'>
					...
					<div className='flex flex-col items-center lg:items-start'>
						<Link to='/'>
							<img src='https://antigen.kz/wp-content/uploads/2025/02/logotip.png' alt='Логотип' className='w-24' />
						</Link>
					</div>
					...
					<div className='flex flex-col justify-between'>
						...
						<div className='flex flex-col items-center lg:items-start'>
							...
							<div className='flex gap-4'>
								...
								<a
									href='https://www.instagram.com/antigen.chem/'
									target='_blank'
									rel='noopener noreferrer'
								>
				...
				<div className='border-t border-white/20 mt-6 pt-6 text-center text-xs text-gray-200'>
					© {new Date().getFullYear()} ТОО Антиген
					Все права защищены.
				</div>
			</div>
		</motion.footer>
